...
export default function HomePage() {
  ...
  async function handleImportLegacyClick() {
    try {
      await Unload();
    } catch (e) {
      console.error(e);
    ...
    const path = await SelectLegacyDashboardFile();
    ...
    <div className="w-full h-full grid place-items-center">
      <Card className="max-w-[380px] w-full">
        <CardHeader>
          ...
          <CardDescription>
            Monitor your mail servers in a central location.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col space-y-2.5">
            ...
            {lastOpenedFile != "" && (
              <Button variant={"secondary"} onClick={handleLoadRecentlyClick}>
